<?php
	/**
		* The Classic Without Sidebar template for Category.
		*
		* @package WordPress
		* @subpackage MyStem
		* @since MyStem 1.2
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>		
				<div class="post-img">
					...
					<?php
						...
						<a href="<?php the_permalink(); ?>" rel="bookmark"><img src="<?php echo MyStem_Category_Temlates_Url .'assets/img/no-image-icon.png';?>"></a>
